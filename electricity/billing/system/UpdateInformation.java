...
public class UpdateInformation extends JFrame implements ActionListener{
    JTextField tfaddress, tfcity, tfstate, tfemail, tfphonenumber;
    ...
    UpdateInformation(String meter){
        ...
        tfstate.setBounds(230, 230, 200, 30);
        add(tfstate);
        ...
        lblphonenumber.setBounds(30, 310, 100, 20);
        add(lblphonenumber);
        tfphonenumber = new JTextField("");
        tfphonenumber.setBounds(230, 310, 200, 20);
        add(tfphonenumber);
